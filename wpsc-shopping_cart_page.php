...
<table class="productcart">
	<tr class="firstrow">
		<td colspan="2" ><?php _e('Product', 'wpsc'); ?></td>
   ...
   <?php while (wpsc_have_cart_items()) : wpsc_the_cart_item(); ?>
      ...
      <tr class="product_row product_row_<?php echo wpsc_the_cart_item_key(); ?> <?php echo $alt_class;?>">
         ...
         <td class="wpsc_product_name wpsc_product_name_<?php echo wpsc_the_cart_item_key(); ?>">
            <a href="<?php echo wpsc_cart_item_url();?>"><?php echo wpsc_cart_item_name();echo wpsc_cart_item_name();echo wpsc_cart_item_name(); ?></a>
         </td>
