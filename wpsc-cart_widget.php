...
<?php if(wpsc_cart_item_count() > 0): ?>
	...
	<table style="width:145px;">
		<thead>
			<tr>
				<th  style="width:40px;" id="product"><?php _e('Product', 'wpsc'); ?></th>
		...
		<?php while(wpsc_have_cart_items()): wpsc_the_cart_item(); ?>
			<tr>
					<td class='product-name' style="width:40px;"><a href="<?php echo wpsc_cart_item_url(); ?>"><?php echo wpsc_cart_item_name(); ?></a></td>
